...
class RookUnitTest {
    ...
    fun getMovePosRook_1_Test() {
        ...
        player.getValue(true).pieces[MainGame.Pos(3, 3)] = "飛"
    ...
    fun getMovePosRook_2_Test() {
        val player = mapOf(true to MainGame.Player(), false to MainGame.Player())
        player.getValue(true).pieces[MainGame.Pos(5, 3)] = "飛"
        val move = MainGame.getMovePos(
    ...
    fun getMovePosRook_3_Test() {
        val player = mapOf(true to MainGame.Player(), false to MainGame.Player())
        player.getValue(true).pieces[MainGame.Pos(1, 3)] = "飛"
        val move = MainGame.getMovePos(
    ...
    fun getMovePosRook_4_Test() {
        val player = mapOf(true to MainGame.Player(), false to MainGame.Player())
        player.getValue(true).pieces[MainGame.Pos(3, 5)] = "飛"
        val move = MainGame.getMovePos(
    ...
    fun getMovePosRook_5_Test() {
        val player = mapOf(true to MainGame.Player(), false to MainGame.Player())
        player.getValue(true).pieces[MainGame.Pos(3, 1)] = "飛"
        val move = MainGame.getMovePos(
    ...
    fun getMovePosRook_6_Test() {
        val player = mapOf(true to MainGame.Player(), false to MainGame.Player())
        player.getValue(true).pieces[MainGame.Pos(4, 2)] = "飛"
        val move = MainGame.getMovePos(
    ...
    fun getMovePosRook_7_Test() {
        val player = mapOf(true to MainGame.Player(), false to MainGame.Player())
        player.getValue(true).pieces[MainGame.Pos(3, 3)] = "飛"
        player.getValue(true).pieces[MainGame.Pos(3, 1)] = "歩"
        player.getValue(true).pieces[MainGame.Pos(4, 3)] = "歩"
        player.getValue(true).pieces[MainGame.Pos(1, 3)] = "歩"
    ...
    fun getMovePosRook_8_Test() {
        val player = mapOf(true to MainGame.Player(), false to MainGame.Player())
        player.getValue(true).pieces[MainGame.Pos(2, 4)] = "飛"
    ...
    fun getMovePosRook_9_Test() {
        val player = mapOf(true to MainGame.Player(), false to MainGame.Player())
        player.getValue(false).pieces[MainGame.Pos(3, 3)] = "飛"
        val move = MainGame.getMovePos(
            piece = mapOf(MainGame.Pos(3, 3) to "飛").entries.first(),
            player.getValue(false),
            player.getValue(true),
    ...
    fun getMovePosRook_10_Test() {
        val player = mapOf(true to MainGame.Player(), false to MainGame.Player())
        player.getValue(false).pieces[MainGame.Pos(5, 3)] = "飛"
        val move = MainGame.getMovePos(
            piece = mapOf(MainGame.Pos(5, 3) to "飛").entries.first(),
            player.getValue(false),
            player.getValue(true),
    ...
    fun getMovePosRook_11_Test() {
        val player = mapOf(true to MainGame.Player(), false to MainGame.Player())
        player.getValue(false).pieces[MainGame.Pos(1, 3)] = "飛"
        val move = MainGame.getMovePos(
            piece = mapOf(MainGame.Pos(1, 3) to "飛").entries.first(),
            player.getValue(false),
            player.getValue(true),
    ...
    fun getMovePosRook_12_Test() {
        val player = mapOf(true to MainGame.Player(), false to MainGame.Player())
        player.getValue(false).pieces[MainGame.Pos(3, 5)] = "飛"
        val move = MainGame.getMovePos(
            piece = mapOf(MainGame.Pos(3, 5) to "飛").entries.first(),
            player.getValue(false),
            player.getValue(true),
    ...
    fun getMovePosRook_13_Test() {
        val player = mapOf(true to MainGame.Player(), false to MainGame.Player())
        player.getValue(false).pieces[MainGame.Pos(3, 1)] = "飛"
        val move = MainGame.getMovePos(
            piece = mapOf(MainGame.Pos(3, 1) to "飛").entries.first(),
            player.getValue(false),
            player.getValue(true),
    ...
    fun getMovePosRook_14_Test() {
        val player = mapOf(true to MainGame.Player(), false to MainGame.Player())
        player.getValue(false).pieces[MainGame.Pos(4, 2)] = "飛"
        val move = MainGame.getMovePos(
            piece = mapOf(MainGame.Pos(4, 2) to "飛").entries.first(),
            player.getValue(false),
            player.getValue(true),
    ...
    fun getMovePosRook_15_Test() {
        val player = mapOf(true to MainGame.Player(), false to MainGame.Player())
        player.getValue(false).pieces[MainGame.Pos(3, 3)] = "飛"
        player.getValue(false).pieces[MainGame.Pos(3, 1)] = "歩"
        player.getValue(false).pieces[MainGame.Pos(4, 3)] = "歩"
        player.getValue(false).pieces[MainGame.Pos(1, 3)] = "歩"
    ...
    fun getMovePosRook_16_Test() {
        val player = mapOf(true to MainGame.Player(), false to MainGame.Player())
        player.getValue(false).pieces[MainGame.Pos(2, 4)] = "飛"
